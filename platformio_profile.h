...
#define DRIVER_ESP32_EXT_MCP2515 // ESP32 + external MCP2515 via SPI (use esp32_ext_mcp2515 env)
...
#define DASH_SSID "canwifi"      // WiFi AP name
#define DASH_PASS "tesla0709"     // WiFi password (min 8 chars)
#define DASH_OTA_USER "admin"    // OTA username
#define DASH_OTA_PASS "admin0709" // OTA password
